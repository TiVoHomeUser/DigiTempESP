...
//// **************************
//// For DHT Sensor
//#define WDHT // Comment out if not using the Temperature Humidity sensor with the access point
////#ifdef WDHT
////#include  "C:\\Users\\victor.wheeler\\Documents\\Arduino\\CommonFiles\\DigiTemp.ino"  // Bad... should rename and add to both Server and Client folder as a header file
//// #include "/Users/imac/Documents/Arduino/CommonFiles/DigiTemp/DigiTemp.ino"  // Bad... should rename and add to both Server and Client folder as a header file
////#include "DigiTempServer.h" // needs someway for this to be common to both Server and Client
////#include <DigiTemp.h>       // Located in Libraies
//#include "DigiTemp.h"         // Located in current folder (for editing)
//
////#endif    // WDHT
//// ************************
//
...
//xxxxxxxxxxxxxx
//
//#else // Server only no sensor
//
//boolean checkLocalStation(clist* addss) { // no need if WDHT not included
//  addss->isAlive = false;
//  return false;
//}
//
